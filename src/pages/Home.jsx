...
export const Home = () => {
    ...
    const scroll = (direction) => {
        if (carouselRef.current) {
            const scrollAmount = carouselRef.current.offsetWidth; // full container width
            if (direction === "left") {
    ...
    return <>
...

                {
                    services.slice(0, 10).map((s, index) => {
                        ...
                        return (
                            ...
                            <ScrollAnimate animation="bottom-to-top-1 c3" key={id}>

                                <div className="inside-fourth-card" >
...

                    {
                        faq.map((f, index) => {
                            ...
                            return (
                                ...
                                <ScrollAnimate animation="bottom-to-top-1 " key={id}>
                                    <div className="faq" >
        ...
        <div className="ninth-section">
            <div className='ninth-section-heading'>
                <h1 >our blog</h1>
            ...
            <div className="carousel-wrapper">
                ...
                <div className="inside-ninth-section" ref={carouselRef}>
                    {blog.map((b, index) => {
                        const { id, image, title, intro } = b;

                        return (
                            <ScrollAnimate animation="bottom-to-top-1 center" key={id}>
                                <div className="blog-card">
                                    ...
                                    <div className="blog-card-content">
                                        ...
                                        <NavLink
                                            className="noneNav"
                                            to={`/blog/${slugify(title, { lower: true })}`}
                                        >
